...
const Header = ({ sumData, headerTitle }) => {
  const { sumtotal, sumqty } = sumData;
  const { aimagcode, soumcode } = useParams();
  const percent = sumtotal ? (sumqty / sumtotal) * 100 : 0;
  return (
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-2xl font-bold">{numberFormat(sumqty)}</p>
            </div>
          </div>
        </div>
        <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-2xl font-bold">{numberFormat(sumtotal)}</p>
            </div>
          </div>
        </div>
        <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-2xl font-bold">{numberFormat(percent, 2)}%</p>
            </div>
          </div>
        </div>
      </div>
